...
| [`corex_admin`](https://hex.pm/packages/corex_admin) | Hex dep | Context-first, deny-by-default LiveView admin for Phoenix+Ecto ([docs](https://hexdocs.pm/corex_admin)) | Manual (`mix corex.admin.install`) |
