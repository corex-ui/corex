  ...
  defp docs_filter_modules(mod, _metadata) do
    allowed =
      MapSet.new([
        ...
        CorexAdmin.Policy,
        CorexAdmin.Resource,
        CorexAdmin.Resource.Spec,
        CorexAdmin.Resource.Field,
        CorexAdmin.Resource.Filter,
        CorexAdmin.Resource.Relation,
        CorexAdmin.ListOpts,
        CorexAdmin.Page,
        CorexAdmin.Query,
        CorexAdmin.Query.Ref,
        CorexAdmin.Filter,
        CorexAdmin.Filter.Cast,
        CorexAdmin.Filter.Select,
        CorexAdmin.Filter.MultiSelect,
        CorexAdmin.Filter.Tags,
        CorexAdmin.Filter.Text,
        CorexAdmin.Filter.Id,
        CorexAdmin.Filter.Number,
        CorexAdmin.Filter.NumberRange,
        CorexAdmin.Filter.DateRange,
        CorexAdmin.Filter.DatetimeRange,
        CorexAdmin.Filter.Boolean,
        CorexAdmin.Filter.Presence,
        CorexAdmin.Filter.RelativeDate,
        CorexAdmin.State.Filters,
        CorexAdmin.Params,
        CorexAdmin.Attrs,
        CorexAdmin.Eject,
        CorexAdmin.UI,
        ...
        CorexAdmin.UI.Labels,
        CorexAdmin.Router,
        Mix.Tasks.Corex.Admin.Install,
        Mix.Tasks.Corex.Admin.Gen.Resource,
        Mix.Tasks.Corex.Admin.Gen.Live,
        Mix.Tasks.Corex.Admin.Gen.Admin,
        Mix.Tasks.Corex.Admin.Doctor,
        CorexAdmin.Live,
        CorexAdmin.Live.Index.Controller,
        CorexAdmin.Live.Show.Controller,
        CorexAdmin.Live.Form.Controller,
        CorexAdmin.Field,
        CorexAdmin.Action,
        CorexAdmin.Action.Delete,
