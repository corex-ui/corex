    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          {ExSlop.Check.Readability.DocFalseOnPublicFunction, false},
          ...
          {OeditusCredo.Check.Warning.UnmanagedTask, false},
          ...
          {OeditusCredo.Check.Security.OSCommandInjection, false},
          {OeditusCredo.Check.Security.CodeInjection,
           [files: %{excluded: ["lib/mix/"]}]},
