...
- Theme color fills use `lightness` (0–100 OKLCH L% targets) resolved via dense `Color.Palette.tonal/2` ramps; border utility ratios lowered for subtler borders.
