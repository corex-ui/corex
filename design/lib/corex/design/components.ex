defmodule Corex.Design.Components do
  ...
  @components %{
    ...
    "progress" => %{family: :static},
    "rating-group" => %{family: :selection},
    "steps" => %{family: :selection},
    "qr-code" => %{family: :static},
    "presence" => %{family: :static},
    "splitter" => %{family: :action},
    "scroll-area" => %{family: :static},
    "toc" => %{family: :selection},
    "date-input" => %{family: :field},
    "image-cropper" => %{family: :action},
    "navigation-menu" => %{family: :action},
    "cascade-select" => %{family: :action},
    "tour" => %{family: :action},
