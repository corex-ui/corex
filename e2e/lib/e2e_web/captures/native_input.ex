defmodule CorexWeb.NativeInput do
  ...
  capture variants: [
            text_with_icon: %{
              ...
              icon: [%{inner_block: ~S(<.heroicon name="hero-pencil-square" />)}]
            },
            text_basic: %{
              type: "text",
              class: "native-input",
            ...
            email_with_icon: %{
              ...
              icon: [%{inner_block: ~S(<.heroicon name="hero-envelope" />)}]
            },
            email_basic: %{
              type: "email",
              class: "native-input",
            ...
            url_with_icon: %{
              ...
              icon: [%{inner_block: ~S(<.heroicon name="hero-link" />)}]
            },
            url_basic: %{
              type: "url",
              class: "native-input",
            ...
            tel_with_icon: %{
              ...
              icon: [%{inner_block: ~S(<.heroicon name="hero-phone" />)}]
            },
            tel_basic: %{
              type: "tel",
              class: "native-input",
            ...
            search_with_icon: %{
              ...
              icon: [%{inner_block: ~S(<.heroicon name="hero-magnifying-glass" />)}]
            },
            search_basic: %{
              type: "search",
              class: "native-input",
            ...
            password_with_icon: %{
              ...
              icon: [%{inner_block: ~S(<.heroicon name="hero-lock-closed" />)}]
            },
            password_basic: %{
              type: "password",
              class: "native-input",
