defmodule E2eWeb.App.Footer do
  ...
  def footer(assigns) do
    {footer_class, content_class} =
      if assigns.variant == :marketing do
        {Shell.footer_marketing(), Shell.footer_content_marketing()}
      else
        {Shell.footer(), Shell.footer_content()}
      end
    ...
    ~H"""
    <footer class={@footer_class <> " shell-footer"}>
      <div :if={@variant == :marketing} id="home-footer" class={@content_class}>
        <div class="flex w-full flex-col gap-space-lg md:flex-row md:items-start md:justify-between">
          ...
          <div class="flex flex-wrap items-center gap-space-sm">
            <.navigate
              ...
              class="button ui-accent ui-solid ui-size-sm ui-rounded-full"
            >
              {~t"Browse components"}
        ...
        <div class="grid w-full grid-cols-1 gap-size-lg sm:grid-cols-3">
          <div class="flex flex-col gap-space-sm">
            ...
            <.navigate class="link ui-nav ui-size-sm" to={hexdocs_url() <> "/forms.html"} external>
              {~t"Forms"}
              <.heroicon name="hero-arrow-top-right-on-square" />
            </.navigate>
            <.navigate
          ...
          <div class="flex flex-col gap-space-sm">
            <p class="m-0 text-sm font-semibold text-ink">{~t"Community"}</p>
            <.navigate
              class="link ui-nav ui-size-sm"
            ...
            <.navigate class="link ui-nav ui-size-sm" to={hexdocs_url()} external>
              {~t"Hexdocs"}
              <.heroicon name="hero-arrow-top-right-on-square" />
            </.navigate>
            <.navigate class="link ui-nav ui-size-sm" to="/feed.xml" external>
              {~t"RSS"}
              <.heroicon name="hero-arrow-top-right-on-square" />
            </.navigate>
            <.navigate class="link ui-nav ui-size-sm" to="https://netoum.com" external>
              {~t"Netoum"}
              <.heroicon name="hero-arrow-top-right-on-square" />
            </.navigate>
          </div>
      ...
      <div :if={@variant == :app} class={@content_class}>
        <div class="grid w-full grid-cols-1 gap-size-lg md:grid-cols-4">
          <div class="flex flex-col gap-space">
            ...
            <.navigate
              class="link ui-accent ui-size-sm self-start"
              to="https://github.com/sponsors/corex-ui"
              external
            >
              {~t"Become a sponsor"}
        ...
        <div class="flex w-full flex-wrap items-center justify-between gap-space border-t border-border pt-space">
          ...
          <div class={"#{Shell.row()} gap-2 flex-wrap justify-end items-center min-w-0"}>
            <.locale_switcher path={@path} />
            <.navigate
