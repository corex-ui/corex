defmodule E2eWeb.Demos.CascadeSelectDemo do
  ...
  def styling_variant_matrix_code do
    for semantic <- DemoScales.styling_semantic_axis_steps("cascade-select"),
      ...
      class = DemoScales.join_matrix_modifiers("cascade-select", semantic.modifier, variant.modifier)
  ...
  def styling_max_width_example(assigns) do
    assigns = assign(assigns, :max_width_variants, DemoScales.max_width_variants("cascade-select") |> Enum.take(4))
