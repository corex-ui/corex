defmodule E2eWeb.Demos.DatePickerDemo do
  ...
  def api_set_value_client_binding_code do
    ~S"""
    <.action phx-click={Corex.DatePicker.set_value("date-picker-api-sv-client", "2024-01-15")} size="sm">
      Set to 2024-01-15
    </.action>
    <.action phx-click={Corex.DatePicker.set_value("date-picker-api-sv-client", "2024-12-25")} size="sm">
      Set to 2024-12-25
    </.action>
  ...
  def api_set_value_server_heex do
    ~S"""
    <.action phx-click="date_picker_api_set_value" phx-value-date="2024-01-15" size="sm">
      Set to 2024-01-15
    </.action>

    <.date_picker translation={%Corex.DatePicker.Translation{open_calendar: "Select date", close_calendar: "Select date", input: "Select date"}} >
      <:label>Select a date</:label>
      <:trigger><.heroicon name="hero-calendar" /></:trigger>
      <:prev_trigger><.heroicon name="hero-chevron-left" /></:prev_trigger>
      <:next_trigger><.heroicon name="hero-chevron-right" /></:next_trigger>
  ...
  defp form_preview_phoenix_form(assigns) do
    ...
    <.form :let={f} for={@form} action={~p"/date-picker/form"} method="post" id={@form_id}>
      <.form_date_picker
        ...
        label={@picker_label}
      />
      <.action type="submit" id={@submit_id} semantic="accent">Submit</.action>
    </.form>
    """
  end
  ...
  def styling_semantic_code do
    ~S"""
    <.date_picker  value="2024-06-15">
      <:label>Default</:label>
      <:trigger><.heroicon name="hero-calendar" /></:trigger>
      <:prev_trigger><.heroicon name="hero-chevron-left" /></:prev_trigger>
      <:next_trigger><.heroicon name="hero-chevron-right" /></:next_trigger>
    </.date_picker>
    <.date_picker class="date-picker date-picker--semantic-accent" value="2024-06-15">
      <:label>Accent</:label>
      <:trigger><.heroicon name="hero-calendar" /></:trigger>
      <:prev_trigger><.heroicon name="hero-chevron-left" /></:prev_trigger>
      <:next_trigger><.heroicon name="hero-chevron-right" /></:next_trigger>
    </.date_picker>
    <.date_picker class="date-picker date-picker--semantic-brand" value="2024-06-15">
      <:label>Brand</:label>
      <:trigger><.heroicon name="hero-calendar" /></:trigger>
      <:prev_trigger><.heroicon name="hero-chevron-left" /></:prev_trigger>
      <:next_trigger><.heroicon name="hero-chevron-right" /></:next_trigger>
    </.date_picker>
    <.date_picker class="date-picker date-picker--semantic-alert" value="2024-06-15">
      <:label>Alert</:label>
      <:trigger><.heroicon name="hero-calendar" /></:trigger>
      <:prev_trigger><.heroicon name="hero-chevron-left" /></:prev_trigger>
      <:next_trigger><.heroicon name="hero-chevron-right" /></:next_trigger>
    </.date_picker>
    <.date_picker class="date-picker date-picker--semantic-info" value="2024-06-15">
      <:label>Info</:label>
      <:trigger><.heroicon name="hero-calendar" /></:trigger>
      <:prev_trigger><.heroicon name="hero-chevron-left" /></:prev_trigger>
      <:next_trigger><.heroicon name="hero-chevron-right" /></:next_trigger>
    </.date_picker>
    <.date_picker class="date-picker date-picker--semantic-success" value="2024-06-15">
      <:label>Success</:label>
      <:trigger><.heroicon name="hero-calendar" /></:trigger>
      <:prev_trigger><.heroicon name="hero-chevron-left" /></:prev_trigger>
      <:next_trigger><.heroicon name="hero-chevron-right" /></:next_trigger>
  ...
  def styling_semantic_example(assigns) do
    ...
    <div class="flex flex-wrap gap-6 items-start w-full">
      ...
      <.date_picker
        ...
        class="date-picker date-picker--semantic-accent"
        value="2024-06-15"
        focused_value="2024-06-01"
        translation={styling_translation()}
      >
      ...
      <.date_picker
        ...
        class="date-picker date-picker--semantic-brand"
        value="2024-06-15"
        focused_value="2024-06-01"
        translation={styling_translation()}
      >
      ...
      <.date_picker
        ...
        class="date-picker date-picker--semantic-alert"
        value="2024-06-15"
        focused_value="2024-06-01"
        translation={styling_translation()}
      >
      ...
      <.date_picker
        ...
        class="date-picker date-picker--semantic-info"
        value="2024-06-15"
        focused_value="2024-06-01"
        translation={styling_translation()}
      >
      ...
      <.date_picker
        ...
        class="date-picker date-picker--semantic-success"
        value="2024-06-15"
        focused_value="2024-06-01"
        translation={styling_translation()}
      >
  ...
  def styling_size_code do
    ~S"""
    <.date_picker class="date-picker date-picker--size-sm" value="2024-06-15">
      <:label>SM</:label>
      <:trigger><.heroicon name="hero-calendar" /></:trigger>
      <:prev_trigger><.heroicon name="hero-chevron-left" /></:prev_trigger>
      <:next_trigger><.heroicon name="hero-chevron-right" /></:next_trigger>
    </.date_picker>
    <.date_picker class="date-picker date-picker--size-md" value="2024-06-15">
      <:label>MD</:label>
      <:trigger><.heroicon name="hero-calendar" /></:trigger>
      <:prev_trigger><.heroicon name="hero-chevron-left" /></:prev_trigger>
      <:next_trigger><.heroicon name="hero-chevron-right" /></:next_trigger>
    </.date_picker>
    <.date_picker class="date-picker date-picker--size-lg" value="2024-06-15">
      <:label>LG</:label>
      <:trigger><.heroicon name="hero-calendar" /></:trigger>
      <:prev_trigger><.heroicon name="hero-chevron-left" /></:prev_trigger>
      <:next_trigger><.heroicon name="hero-chevron-right" /></:next_trigger>
    </.date_picker>
    <.date_picker class="date-picker date-picker--size-xl" value="2024-06-15">
      <:label>XL</:label>
      <:trigger><.heroicon name="hero-calendar" /></:trigger>
      <:prev_trigger><.heroicon name="hero-chevron-left" /></:prev_trigger>
      <:next_trigger><.heroicon name="hero-chevron-right" /></:next_trigger>
  ...
  def styling_size_example(assigns) do
    ...
    <div class="flex flex-wrap gap-6 items-start">
      <.date_picker
        ...
        class="date-picker date-picker--size-sm"
        value="2024-06-15"
        focused_value="2024-06-01"
        translation={styling_translation()}
      >
      ...
      <.date_picker
        ...
        class="date-picker date-picker--size-md"
        value="2024-06-15"
        focused_value="2024-06-01"
        translation={styling_translation()}
      >
      ...
      <.date_picker
        ...
        class="date-picker date-picker--size-lg"
        value="2024-06-15"
        focused_value="2024-06-01"
        translation={styling_translation()}
      >
      ...
      <.date_picker
        ...
        class="date-picker date-picker--size-xl"
        value="2024-06-15"
        focused_value="2024-06-01"
        translation={styling_translation()}
      >
