defmodule E2eWeb.Demos.EditableDemo do
  ...
  def styling_semantic_code do
    ...
    """
    <.editable  value="Default">
    #{slots}
    </.editable>
    <.editable class="editable editable--semantic-accent" value="Accent">
    #{slots}
    </.editable>
    <.editable class="editable editable--semantic-brand" value="Brand">
    #{slots}
    </.editable>
    <.editable class="editable editable--semantic-alert" value="Alert">
    #{slots}
    </.editable>
    <.editable class="editable editable--semantic-info" value="Info">
    #{slots}
    </.editable>
    <.editable class="editable editable--semantic-success" value="Success">
    #{slots}
    </.editable>
    """
  end
  ...
  def styling_semantic_example(assigns) do
    ...
    <div class="flex flex-wrap gap-6 items-start">
      <.editable id="editable-style-color-default" value="Default">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
      </.editable>
      <.editable id="editable-style-color-accent" class="editable editable--semantic-accent" value="Accent">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
      </.editable>
      <.editable id="editable-style-color-brand" class="editable editable--semantic-brand" value="Brand">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
      </.editable>
      <.editable id="editable-style-color-alert" class="editable editable--semantic-alert" value="Alert">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
      </.editable>
      <.editable id="editable-style-color-info" class="editable editable--semantic-info" value="Info">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
      </.editable>
      <.editable id="editable-style-color-success" class="editable editable--semantic-success" value="Success">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
  ...
  def styling_size_code do
    ...
    """
    <.editable class="editable editable--size-sm" value="SM">
    #{slots}
    </.editable>
    <.editable class="editable editable--size-md" value="MD">
    #{slots}
    </.editable>
    <.editable class="editable editable--size-lg" value="LG">
    #{slots}
    </.editable>
    <.editable class="editable editable--size-xl" value="XL">
    #{slots}
    </.editable>
    """
  end
  ...
  def styling_size_example(assigns) do
    ...
    <div class="flex flex-col gap-4 items-start">
      <.editable id="editable-style-sm" class="editable editable--size-sm" value="SM">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
      </.editable>
      <.editable id="editable-style-md" class="editable editable--size-md" value="MD">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
      </.editable>
      <.editable id="editable-style-lg" class="editable editable--size-lg" value="LG">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
      </.editable>
      <.editable id="editable-style-xl" class="editable editable--size-xl" value="XL">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
  ...
  def styling_max_width_code do
    ...
    """
    <.editable class="editable editable--max-w-2xs" value="2xs">
    #{slots}
    </.editable>
    <.editable class="editable editable--max-w-md" value="MD">
    #{slots}
    </.editable>
    <.editable class="editable editable--max-w-xl" value="XL">
    #{slots}
    </.editable>
    <.editable class="editable editable--max-w-2xl" value="2XL">
    #{slots}
    </.editable>
    """
  end
  ...
  def styling_max_width_example(assigns) do
    ...
    ~H"""
    <div class="flex flex-col gap-4 items-start">
      <.editable id="editable-style-max-2xs" class="editable editable--max-w-2xs" value="2xs">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
      </.editable>
      <.editable id="editable-style-max-md" class="editable editable--max-w-md" value="MD">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
      </.editable>
      <.editable id="editable-style-max-xl" class="editable editable--max-w-xl" value="XL">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
      </.editable>
      <.editable id="editable-style-max-2xl" class="editable editable--max-w-2xl" value="2XL">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
  ...
  def api_set_value_client_binding_heex do
    ...
    <div class="layout__row">
      <.action phx-click={Corex.Editable.set_value("editable-api-cb", "Alpha")} size="sm">Alpha</.action>
      <.action phx-click={Corex.Editable.set_value("editable-api-cb", "Beta")} size="sm">Beta</.action>
    </div>
    <.editable  value="Start">
      <:label>Label</:label>
      <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
      <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
      <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
  ...
  def api_set_value_client_binding_example(assigns) do
    ...
    <.editable id="editable-api-cb" value="Start">
      <:label>Label</:label>
      <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
      <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
      <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
  ...
  def api_set_value_client_js_example(assigns) do
    ...
    <div class="w-full max-w-4xl flex flex-col gap-4 items-center">
      ...
      <.editable id="editable-api-cjs" value="Start">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
  ...
  def api_set_value_server_heex do
    ~S"""
    <div class="layout__row">
      <.action phx-click="editable_api_alpha" size="sm">Alpha</.action>
      <.action phx-click="editable_api_beta" size="sm">Beta</.action>
    </div>
    <.editable  value="Start">
      <:label>Label</:label>
      <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
  ...
  def api_set_value_server_example(assigns) do
    ...
    <div class="w-full max-w-4xl flex flex-col gap-4 items-center">
      ...
      <.editable id="editable-api-srv" value="Start">
        <:label>Label</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
  ...
  def form_doc_controller_phoenix_heex do
    ...
    <.form
      ...
      method="post"
    >
      <.editable field={@form[:text]} placeholder="Enter text" activation_mode="dblclick" select_on_focus >
        <:label>Text</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
  ...
  def form_native_heex do
    ...
    <form action={~p"/editable/form"} method="post">
      ...
      <.editable name="editable[text]" value="" placeholder="Enter text" activation_mode="dblclick" select_on_focus >
        <:label>Text</:label>
        <:edit_trigger><.heroicon name="hero-pencil-square" /></:edit_trigger>
        <:submit_trigger><.heroicon name="hero-check" /></:submit_trigger>
        <:cancel_trigger><.heroicon name="hero-x-mark" /></:cancel_trigger>
  ...
  def form_doc_live_ecto_heex do
    ...
    <.form for={@form} phx-change="validate" phx-submit="save">
      <.editable field={@form[:text]} on_value_change="value_changed" placeholder="Enter text" activation_mode="dblclick" select_on_focus >
        <:label>Text</:label>
        <:error :let={msg}>
          <.heroicon name="hero-exclamation-circle" />
          {msg}
  ...
  def form_preview_controller_phoenix(assigns) do
    ...
    >
      ...
      <.action type="submit" id="editable-form-phoenix-submit" semantic="accent">
        Submit
      </.action>
    </.form>
    """
  ...
  def form_preview_controller_ecto(assigns) do
    ...
    >
      ...
      <.action type="submit" id="editable-form-ecto-submit" semantic="accent">
        Submit
      </.action>
    </.form>
    """
  ...
  def form_preview_controller_native(assigns) do
    ...
    <form action={~p"/editable/form"} method="post" id="editable-form-native">
      ...
      <.action type="submit" id="editable-form-native-submit" semantic="accent">
        Submit
      </.action>
    </form>
    """
  ...
  def form_preview_live_phoenix(assigns) do
    ...
    <.form for={@form} phx-submit="save_phoenix">
      ...
      <.action type="submit" id="editable-live-form-phoenix-submit" semantic="accent">
        Submit
      </.action>
    </.form>
    """
  ...
  def form_preview_live_ecto(assigns) do
    ...
    <.form for={@form} phx-change="validate" phx-submit="save">
      ...
      <.action type="submit" id="editable-live-form-ecto-submit" semantic="accent">
        Submit
      </.action>
    </.form>
    """
  ...
  def form_preview_live_changeset(assigns) do
    ...
    >
      ...
      <.action type="submit" id="editable-form-live-submit" semantic="accent">
        Submit
      </.action>
    </.form>
    """
  ...
  def style_preview(assigns), do: E2eWeb.Demos.StylePreview.preview(:editable, assigns)
