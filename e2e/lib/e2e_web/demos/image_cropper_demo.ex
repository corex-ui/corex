defmodule E2eWeb.Demos.ImageCropperDemo do
  ...
  def styling_color_example(assigns) do
    ...
    ~H"""
    <div class="flex flex-wrap gap-space-sm items-start">
    <.image_cropper id="image-cropper-style-default" class="image-cropper" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-accent" class="image-cropper ui-accent" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-brand" class="image-cropper ui-brand" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-alert" class="image-cropper ui-alert" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-success" class="image-cropper ui-success" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-info" class="image-cropper ui-info" src="/images/tech/elixir.svg" />
    </div>
    """
  end
  ...
  def styling_variant_example(assigns) do
    ...
    ~H"""
    <div class="flex flex-wrap gap-space-sm items-start">
    <.image_cropper id="image-cropper-style-subtle" class="image-cropper" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-solid" class="image-cropper ui-solid" src="/images/tech/elixir.svg" />
    </div>
    """
  end
  ...
  def styling_variant_matrix_code do
    for semantic <- DemoScales.styling_semantic_axis_steps("image-cropper"),
      ...
      class = DemoScales.join_matrix_modifiers("image-cropper", semantic.modifier, variant.modifier)
  ...
  def styling_size_example(assigns) do
    ...
    ~H"""
    <div class="flex flex-wrap gap-space-sm items-start">
    <.image_cropper id="image-cropper-style-size-sm" class="image-cropper ui-size-sm" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-size-md" class="image-cropper ui-size-md" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-size-lg" class="image-cropper ui-size-lg" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-size-xl" class="image-cropper ui-size-xl" src="/images/tech/elixir.svg" />
    </div>
    """
  end
  ...
  def styling_rounded_example(assigns) do
    ...
    ~H"""
    <div class="flex flex-wrap gap-space-sm items-start">
    <.image_cropper id="image-cropper-style-r-none" class="image-cropper ui-rounded-none" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-r-sm" class="image-cropper ui-rounded-sm" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-r-md" class="image-cropper ui-rounded-md" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-r-lg" class="image-cropper ui-rounded-lg" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-r-xl" class="image-cropper ui-rounded-xl" src="/images/tech/elixir.svg" />
    <.image_cropper id="image-cropper-style-r-full" class="image-cropper ui-rounded-full" src="/images/tech/elixir.svg" />
    </div>
    """
  end
  ...
  def styling_max_width_example(assigns) do
    assigns = assign(assigns, :max_width_variants, DemoScales.max_width_variants("image-cropper") |> Enum.take(4))
