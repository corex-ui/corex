defmodule E2eWeb.Demos.StylingAxes do
  ...
  def styling_axis_values(:width), do: axis_values(Keyword.keys(RecipePresets.width_blocks()))
  def styling_axis_values(:max_width), do: axis_values(Keyword.keys(RecipePresets.max_width_blocks()))
  def styling_axis_values(:height), do: axis_values(Keyword.keys(RecipePresets.height_blocks()))
  def styling_axis_values(:max_height), do: axis_values(Keyword.keys(RecipePresets.max_height_blocks()))
