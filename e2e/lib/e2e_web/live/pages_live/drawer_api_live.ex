defmodule E2eWeb.DrawerApiLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} mode={@mode} theme={@theme} path={@path}>
      <.demo_page path={@path} id="drawer-api-page" title="Drawer · API" subtitle="Set open from client bindings, client JS, or a server event. Overlay stays closed on the server.">
        <.demo_section id="drawer-api-set-open-client-binding" title="Set open (Client binding)" code={@codes.set_open_client_binding}>
          <:preview><Demo.api_set_open_client_binding_example /></:preview>
        </.demo_section>
        <.demo_section
          id="drawer-api-set-open-client-js"
