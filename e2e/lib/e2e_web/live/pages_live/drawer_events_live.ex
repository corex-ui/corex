defmodule E2eWeb.DrawerEventsLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} mode={@mode} theme={@theme} path={@path}>
      <.demo_page path={@path} id="drawer-events-page" title="Drawer · Events" subtitle="Open change events.">
        <.demo_section id="drawer-events-section" title="On open change">
          <:preview>
            <div class="flex flex-col gap-space-lg items-center w-full">
              <.drawer id="drawer-events" class="drawer" on_open_change="drawer_open_changed">
