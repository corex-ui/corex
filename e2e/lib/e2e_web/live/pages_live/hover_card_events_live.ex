defmodule E2eWeb.HoverCardEventsLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} mode={@mode} theme={@theme} path={@path}>
      <.demo_page path={@path} id="hover-card-events-page" title="Hover card · Events" subtitle="Open change events.">
        <.demo_section id="hover-card-events-section" title="On open change">
          <:preview>
            <div class="flex flex-col gap-space-lg items-center w-full">
              <.hover_card id="hover-card-events" class="hover-card" on_open_change="hover_card_open_changed">
