defmodule E2eWeb.QrCodeEventsLive do
        ...
        <.demo_section id="qr-code-events-section" title="On value change">
          <:preview>
            <div class="flex flex-col gap-space-lg items-center w-full">
              <.qr_code id="qr-code-events" class="qr-code" on_value_change="qr_code_changed" />
              <.data_table id="qr-code-events-log" class="data-table max-w-3xl" rows={@streams.logs}>
