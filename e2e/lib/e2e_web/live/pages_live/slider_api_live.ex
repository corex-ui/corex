defmodule E2eWeb.SliderApiLive do
  ...
  def render(assigns) do
    ...
    >
      <.demo_page
        ...
        id="slider-api-page"
        title="Slider · API"
        subtitle="Programmatically control the Slider via client or server events."
      >
        <.demo_section
          id="slider-api-set-value-binding"
          title="Set Value (Client Binding)"
          code={@codes.binding}
        >
          <:preview>
            <E2eWeb.Demos.SliderDemo.api_set_value_client_binding_example id={@id_sv_client} />
          </:preview>
        </.demo_section>
        ...
        <.demo_section
          id="slider-api-set-value-server"
