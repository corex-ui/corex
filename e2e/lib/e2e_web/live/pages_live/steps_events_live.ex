defmodule E2eWeb.StepsEventsLive do
        ...
        <.demo_section id="steps-events-section" title="On value change">
          <:preview>
            <div class="flex flex-col gap-space-lg items-center w-full">
              <.steps id="steps-events" class="steps" on_step_change="steps_changed" />
              <.data_table id="steps-events-log" class="data-table max-w-3xl" rows={@streams.logs}>
