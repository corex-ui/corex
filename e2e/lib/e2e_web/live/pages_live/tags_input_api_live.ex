  ...
  def render(assigns) do
    ...
    >
      <.demo_page
        ...
        subtitle="Set and clear tags from LiveView, client bindings, or a DOM dispatch."
      >
        <.demo_section
        ...
        >
          <:preview>
            <.api_set_value_server_example value={@tags} />
          </:preview>
        </.demo_section>
        <.demo_section
        ...
        >
          <:preview>
            <.api_clear_server_example tags_clear={@tags_clear} />
          </:preview>
        </.demo_section>
      </.demo_page>
    </Layouts.app>
