defmodule E2eWeb.TocEventsLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} mode={@mode} theme={@theme} path={@path}>
      <.demo_page path={@path} id="toc-events-page" title="Toc · Events" subtitle="Value change events.">
        <.demo_section id="toc-events-section" title="On value change">
          <:preview>
            <div class="flex flex-col gap-space-lg items-center w-full">
              <.toc id="toc-events" class="toc" on_value_change="toc_changed" />
              <.data_table id="toc-events-log" class="data-table max-w-3xl" rows={@streams.logs}>
