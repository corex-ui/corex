defmodule E2eWeb.TourEventsLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} mode={@mode} theme={@theme} path={@path}>
      <.demo_page path={@path} id="tour-events-page" title="Tour · Events" subtitle="Value change events.">
        <.demo_section id="tour-events-section" title="On value change">
          <:preview>
            <div class="flex flex-col gap-space-lg items-center w-full">
              <.tour id="tour-events" class="tour" on_value_change="tour_changed" />
