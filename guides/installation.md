...
| [`corex_admin`](https://hex.pm/packages/corex_admin) | Hex dep | Context-first, deny-by-default LiveView admin for Phoenix+Ecto ([Getting started](https://hexdocs.pm/corex_admin/installation.html)) | Manual (`mix corex.admin.install`) |
