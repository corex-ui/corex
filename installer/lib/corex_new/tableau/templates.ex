defmodule Corex.New.Tableau.Templates do
  ...
  @templates [
    ...
    tag_layout: "corex_tableau/lib/app/layouts/tag_layout.ex.eex",
    shell: "corex_tableau/lib/app/layouts/shell.ex.eex",
    home_page: "corex_tableau/lib/app/pages/home_page.ex.eex",
    blog_index_page: "corex_tableau/lib/app/pages/blog_index_page.ex.eex",
    tags_index_page: "corex_tableau/lib/app/pages/tags_index_page.ex.eex",
    ...
    code_blocks: "corex_tableau/lib/app/markdown/code_blocks.ex.eex",
    block_renderer: "corex_tableau/lib/app/markdown/block_renderer.ex.eex",
