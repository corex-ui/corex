    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          # Error Handling
          {OeditusCredo.Check.Warning.MissingErrorHandling, false},
          ...
          {OeditusCredo.Check.Warning.MissingTelemetryForExternalHttp,
           [files: %{excluded: ["test/support/http_smoke.ex"]}]},
          # Security - Injection
          ...
          {OeditusCredo.Check.Security.TOCTOU, [files: %{excluded: ["test/"]}]}
        ],
        disabled: [
          #
