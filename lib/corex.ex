defmodule Corex do
  ...
  @components %{
    ...
    progress: {Corex.Progress, [progress: 1]},
    rating_group: {Corex.RatingGroup, [rating_group: 1]},
    steps: {Corex.Steps, [steps: 1]},
    qr_code: {Corex.QrCode, [qr_code: 1]},
    presence: {Corex.Presence, [presence: 1]},
    splitter: {Corex.Splitter, [splitter: 1]},
    scroll_area: {Corex.ScrollArea, [scroll_area: 1]},
    toc: {Corex.Toc, [toc: 1]},
    date_input: {Corex.DateInput, [date_input: 1]},
    image_cropper: {Corex.ImageCropper, [image_cropper: 1]},
    navigation_menu: {Corex.NavigationMenu, [navigation_menu: 1]},
    cascade_select: {Corex.CascadeSelect, [cascade_select: 1]},
    tour: {Corex.Tour, [tour: 1]},
    tree_view:
      {Corex.TreeView,
       [
         tree_view: 1,
