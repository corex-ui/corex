defmodule Corex.Translation do
  ...
  defp gettext_ast({:gettext, _, [text]}), do: quote(do: Corex.Gettext.gettext(unquote(text)))
  defp gettext_ast(text) when is_binary(text), do: quote(do: Corex.Gettext.gettext(unquote(text)))
