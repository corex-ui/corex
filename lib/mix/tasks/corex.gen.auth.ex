defmodule Mix.Tasks.Corex.Gen.Auth do
  ...
  [`mix corex.gen.auth` guide](mix_phx_gen_auth.html).
  ...
  defp validate_required_dependencies! do
    ...
    if generated_with_no_assets_or_esbuild?() do
      ...
      corex.gen.auth expects the phoenix_html JavaScript to be available in your application for
  ...
  defp prompt_for_scope_conflicts(binding) do
    ...
    cond do
      ...
      scope && not new? ->
        ...
        corex.gen.auth expects the configured scope module #{inspect(scope.module)} to include
      ...
      default_scope ->
        ...
        corex.gen.auth will create a new #{scope.name} scope.

        Note that if you run `corex.gen.live` multiple times, the generated assign key for
  ...
  defp raise_with_help(msg, :phx_generator_args) do
    ...
    contains ecto and html templates.
        ...
        mix corex.new my_app --umbrella
        mix corex.new my_app --database mysql
