defmodule Mix.Tasks.Corex.Gen.Schema do
  ...
  Generates an Ecto schema and migration.
      ...
      $ mix corex.gen.schema Blog.Post blog_posts title:string views:integer
  ...
  Via CLI:
      ...
      $ mix corex.gen.schema Blog.Post blog_posts title:string views:integer --context-app marketing
  ...
  the type makes it default to `:string`:
      ...
      $ mix corex.gen.schema Blog.Post blog_posts title views:integer
  ...
  referenced table:
      ...
      $ mix corex.gen.schema Blog.Post blog_posts title user_id:references:users
  ...
  type of the underlying array element to be given too:
      ...
      $ mix corex.gen.schema Blog.Post blog_posts tags:array:string

  Unique columns can be automatically generated by using:

      $ mix corex.gen.schema Blog.Post blog_posts title:unique unique_int:integer:unique

  Redact columns can be automatically generated by using:

      $ mix corex.gen.schema Accounts.Superhero superheroes secret_identity:redact password:string:redact

  Ecto.Enum fields can be generated by using:

      $ mix corex.gen.schema Blog.Post blog_posts title status:enum:unpublished:published:deleted
  ...
  a `--table` option may be provided. For example:
      ...
      $ mix corex.gen.schema Blog.Post posts --table cms_posts
  ...
  allows to change the name of the primary key column. For example:
      ...
      $ mix corex.gen.schema Blog.post posts --primary-key post_id
  ...
  folder with option `--repo`:
      ...
      $ mix corex.gen.schema Blog.Post posts --repo MyApp.Repo.Auth
  ...
  the migration folder path:
      ...
      $ mix corex.gen.schema Blog.Post posts --migration-dir /path/to/directory
  ...
  A prefix can be specified with the `--prefix` flags. For example:
      ...
      $ mix corex.gen.schema Blog.Post posts --prefix blog
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise "mix corex.gen.schema must be invoked from within your *_web application root directory"
    end
  ...
  def copy_new_files(%Schema{context_app: ctx_app, repo: repo, opts: opts} = schema, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/corex.gen.schema", binding, files)
    ...
    if schema.migration? do
      ...
      Mix.Phoenix.copy_from paths, "priv/templates/corex.gen.schema", binding, [
  ...
  def raise_with_help(msg) do
    ...
    mix corex.gen.schema expects both a module name and
    the plural of the generated resource followed by
    any number of attributes:

        mix corex.gen.schema Blog.Post blog_posts title:string
    """
  end
