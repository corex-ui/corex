...
// ../node_modules/.pnpm/@zag-js+checkbox@1.43.3/node_modules/@zag-js/checkbox/dist/checkbox.anatomy.mjs
var anatomy = createAnatomy("checkbox").parts("root", "label", "control", "indicator");
var parts = anatomy.build();

// ../node_modules/.pnpm/@zag-js+checkbox@1.43.3/node_modules/@zag-js/checkbox/dist/checkbox.dom.mjs
...
// ../node_modules/.pnpm/@zag-js+checkbox@1.43.3/node_modules/@zag-js/checkbox/dist/checkbox.connect.mjs
...
// ../node_modules/.pnpm/@zag-js+checkbox@1.43.3/node_modules/@zag-js/checkbox/dist/checkbox.machine.mjs
...
// hooks/checkbox.ts
var CheckboxHook = createZagLiveHook({
  key: "checkbox",
  ...
  mount(hook, { dom, server }) {
    ...
    dom.add("corex:checkbox:set-checked", (event) => {
    ...
    server.add("checkbox_toggle_checked", (payload) => {
      if (!idMatches(el.id, readPayloadId(payload))) return;
      zagCheckbox.api.toggleChecked();
    });
    ...
    server.add("checkbox_checked", (payload) => {
      if (!idMatches(el.id, readPayloadId(payload))) return;
      emitCheckedState(
    ...
    server.add("checkbox_focused", (payload) => {
      if (!idMatches(el.id, readPayloadId(payload))) return;
      emitCheckedState(
        parseRespondTo(payload),
    ...
    server.add("checkbox_disabled", (payload) => {
      if (!idMatches(el.id, readPayloadId(payload))) return;
      emitCheckedState(
        parseRespondTo(payload),
