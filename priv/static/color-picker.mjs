...
} from "./chunks/chunk-IWZKGRXV.mjs";
import "./chunks/chunk-DHINQKK3.mjs";
import {
...
// ../node_modules/.pnpm/@zag-js+color-picker@1.43.3/node_modules/@zag-js/color-picker/dist/color-picker.anatomy.mjs
...
// ../node_modules/.pnpm/@zag-js+color-utils@1.43.3/node_modules/@zag-js/color-utils/dist/chunk-QZ7TP4HQ.mjs
var __defProp = Object.defineProperty;
var __defNormalProp = (obj, key, value) => key in obj ? __defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);

// ../node_modules/.pnpm/@zag-js+color-utils@1.43.3/node_modules/@zag-js/color-utils/dist/color-format-gradient.mjs
...
// ../node_modules/.pnpm/@zag-js+color-utils@1.43.3/node_modules/@zag-js/color-utils/dist/area-gradient.mjs
...
// ../node_modules/.pnpm/@zag-js+color-utils@1.43.3/node_modules/@zag-js/color-utils/dist/color.mjs
...
// ../node_modules/.pnpm/@zag-js+color-utils@1.43.3/node_modules/@zag-js/color-utils/dist/rgb-color.mjs
...
// ../node_modules/.pnpm/@zag-js+color-utils@1.43.3/node_modules/@zag-js/color-utils/dist/hsl-color.mjs
...
// ../node_modules/.pnpm/@zag-js+color-utils@1.43.3/node_modules/@zag-js/color-utils/dist/hsb-color.mjs
...
// ../node_modules/.pnpm/@zag-js+color-utils@1.43.3/node_modules/@zag-js/color-utils/dist/native-color.mjs
...
// ../node_modules/.pnpm/@zag-js+color-utils@1.43.3/node_modules/@zag-js/color-utils/dist/parse-color.mjs
...
// ../node_modules/.pnpm/@zag-js+color-picker@1.43.3/node_modules/@zag-js/color-picker/dist/color-picker.dom.mjs
...
// ../node_modules/.pnpm/@zag-js+color-picker@1.43.3/node_modules/@zag-js/color-picker/dist/utils/get-channel-display-color.mjs
...
// ../node_modules/.pnpm/@zag-js+color-picker@1.43.3/node_modules/@zag-js/color-picker/dist/utils/get-channel-input-value.mjs
...
// ../node_modules/.pnpm/@zag-js+color-picker@1.43.3/node_modules/@zag-js/color-picker/dist/utils/get-slider-background.mjs
...
// ../node_modules/.pnpm/@zag-js+color-picker@1.43.3/node_modules/@zag-js/color-picker/dist/color-picker.connect.mjs
...
// ../node_modules/.pnpm/@zag-js+color-picker@1.43.3/node_modules/@zag-js/color-picker/dist/color-picker.parse.mjs
var parse = (colorString) => {
  return parseColor(colorString);
};

// ../node_modules/.pnpm/@zag-js+color-picker@1.43.3/node_modules/@zag-js/color-picker/dist/utils/is-valid-hex.mjs
...
// ../node_modules/.pnpm/@zag-js+color-picker@1.43.3/node_modules/@zag-js/color-picker/dist/color-picker.machine.mjs
...
function tryParseColor(raw, label = "color") {
  try {
    return parse(raw);
  } catch (error) {
...
function readValueProps(el) {
  ...
  return { defaultValue: defaultVal ? tryParseColor(defaultVal, "defaultValue") : void 0 };
}
var ColorPickerHook = createZagLiveHook({
  key: "colorPicker",
  ...
  mount(hook, { dom, server }) {
    ...
    dom.add("corex:color-picker:set-value", (event) => {
      const { value } = event.detail;
      if (typeof value !== "string") return;
      if (!tryParseColor(value, "set-value")) return;
      zag.api.setValue(value);
    });
    server.add("color_picker_set_value", (payload) => {
  ...
  update(hook, zag) {
    ...
    const parsedValue = valuePatch.value !== void 0 && valuePatch.value ? tryParseColor(valuePatch.value, "value") : void 0;
    zag.updateProps({
      name: getString(el, "name"),
      closeOnSelect: getBoolean(el, "closeOnSelect"),
      openAutoFocus: getBoolean(el, "openAutoFocus"),
