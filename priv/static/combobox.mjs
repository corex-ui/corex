import {
  stripZagSubmitNames
} from "./chunks/chunk-B4RGTWCP.mjs";
import {
  createLiveRegion
...
} from "./chunks/chunk-MTENNSNX.mjs";
import {
  ListCollection,
...
import "./chunks/chunk-52M2556W.mjs";
import {
...
// ../node_modules/.pnpm/@zag-js+combobox@1.43.3/node_modules/@zag-js/combobox/dist/combobox.collection.mjs
...
// ../node_modules/.pnpm/@zag-js+combobox@1.43.3/node_modules/@zag-js/combobox/dist/combobox.dom.mjs
...
// ../node_modules/.pnpm/@zag-js+combobox@1.43.3/node_modules/@zag-js/combobox/dist/combobox.connect.mjs
...
// ../node_modules/.pnpm/@zag-js+combobox@1.43.3/node_modules/@zag-js/combobox/dist/combobox.machine.mjs
...
var Combobox = class extends Component {
  ...
  syncFlatItems(listEl, templatesRoot, items) {
    ...
    for (let index = 0; index < desiredValues.length; index += 1) {
      ...
      if (!itemEl) {
        itemEl = this.cloneItemFromTemplate(templatesRoot, value) ?? void 0;
        if (!itemEl) continue;
  ...
  syncGroupItems(groupEl, blockItems, templatesRoot) {
    ...
    for (let index = 0; index < desiredValues.length; index += 1) {
      ...
      if (!itemEl) {
        ...
        const itemTemplate = groupTemplate?.querySelector(
  ...
  syncGroupedItems(listEl, templatesRoot, items) {
    ...
    for (let index = 0; index < blocks.length; index += 1) {
      ...
      if (!groupEl) {
        groupEl = this.cloneGroupFromTemplate(templatesRoot, block.groupId) ?? void 0;
        if (!groupEl) continue;
