...
// hooks/corex-eager.ts
var corex_eager_exports = {};
__export(corex_eager_exports, {
  ...
  default: () => corex_eager_default
});
module.exports = __toCommonJS(corex_eager_exports);

// ../node_modules/.pnpm/@zag-js+anatomy@1.33.1/node_modules/@zag-js/anatomy/dist/index.mjs
var createAnatomy = (name, parts15 = []) => ({
  parts: (...values) => {
    if (isEmpty(parts15)) {
...
function createScope(props14) {
  const getRootNode2 = () => props14.getRootNode?.() ?? document;
...
var createProps = () => (props14) => Array.from(new Set(props14));
...
var normalizeProps = createNormalizer((props14) => {
...
function bindable(props14) {
  const initial = props14().value ?? props14().defaultValue;
  if (props14().debug) {
    console.log(`[bindable > ${props14().debug}] initial`, initial);
  }
  const eq = props14().isEqual ?? Object.is;
  ...
  return {
    ...
    set(nextValue) {
      ...
      if (!eq(next2, prev2)) {
        props14().onChange?.(next2, prev2);
      }
    },
    invoke(nextValue, prevValue) {
      props14().onChange?.(nextValue, prevValue);
    },
    hash(value) {
      return props14().hash?.(value) ?? String(value);
    }
  };
}
...
var VanillaMachine = class {
  constructor(machine15, userProps = {}) {
    ...
    const prop = (key) => {
      ...
      const props14 = machine15.props?.({ props: compact(__props), scope: this.scope }) ?? __props;
      return props14[key];
    };
    this.prop = prop;
    const context = machine15.context?.({
      prop,
      bindable,
      scope: this.scope,
      flush(fn) {
    ...
    const refs = createRefs(machine15.refs?.({ prop, context: ctx }) ?? {});
    this.refs = refs;
...
var Accordion = class extends Component {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  initMachine(props14) {
    return new VanillaMachine(machine, props14);
  }
  initApi() {
...
var ToastItem = class extends Component {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  initMachine(props14) {
    return new VanillaMachine(machine2, props14);
  }
  initApi() {
...
var ToggleGroup = class extends Component {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  initMachine(props14) {
    return new VanillaMachine(machine3, props14);
  }
  initApi() {
...
var ToggleGroupHook = {
  mounted() {
    ...
    const toggleGroup = new ToggleGroup(el, props14);
    toggleGroup.init();
...
var Switch = class extends Component {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  initMachine(props14) {
    return new VanillaMachine(machine5, props14);
  }
  initApi() {
  ...
  initMachine(props14) {
    ...
    return new VanillaMachine(machine6, {
      ...
      onOpenChange: (details) => {
        ...
        if (props14.onOpenChange) {
          props14.onOpenChange(details);
        }
      },
      onInputValueChange: (details) => {
        ...
        if (props14.onInputValueChange) {
          props14.onInputValueChange(details);
        }
      }
    });
  }
...
var ComboboxHook = {
  mounted() {
    ...
    const combobox = new Combobox(el, props14);
...
var Checkbox = class extends Component {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  initMachine(props14) {
    return new VanillaMachine(machine7, props14);
  }
  initApi() {
...
var Tabs = class extends Component {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  initMachine(props14) {
    return new VanillaMachine(machine8, props14);
  }
  initApi() {
...
var Clipboard = class extends Component {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  initMachine(props14) {
    return new VanillaMachine(machine9, props14);
  }
  initApi() {
...
var Collapsible = class extends Component {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  initMachine(props14) {
    return new VanillaMachine(machine10, props14);
  }
  initApi() {
...
var walkTreeOutside = (originalTarget, props14) => {
  const { parentNode, markerName, controlAttribute, followControlledElements = true } = props14;
...
var Dialog = class extends Component {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  initMachine(props14) {
    return new VanillaMachine(machine11, props14);
  }
  initApi() {
...
function $11d87f3f76e88657$var$getTimeZoneParts(ms, timeZone) {
  ...
  let parts15 = formatter.formatToParts(new Date(ms));
  let namedParts = {};
  for (let part of parts15) if (part.type !== "literal") namedParts[part.type] = part.value;
  return {
...
function $11d87f3f76e88657$var$isValidWallTime(date, timeZone, absolute) {
  let parts15 = $11d87f3f76e88657$var$getTimeZoneParts(absolute, timeZone);
  return date.year === parts15.year && date.month === parts15.month && date.day === parts15.day && date.hour === parts15.hour && date.minute === parts15.minute && date.second === parts15.second;
}
...
function formatRange(startDate, endDate, formatter, toString, timeZone) {
  let parts15 = formatter.formatRangeToParts(startDate.toDate(timeZone), endDate.toDate(timeZone));
  let separatorIndex = -1;
  for (let i2 = 0; i2 < parts15.length; i2++) {
    let part = parts15[i2];
  ...
  for (let i2 = 0; i2 < parts15.length; i2++) {
    if (i2 < separatorIndex) {
      start += parts15[i2].value;
    } else if (i2 > separatorIndex) {
      end += parts15[i2].value;
    }
  }
...
function createRegex(locale, timeZone) {
  ...
  const parts15 = formatter.formatToParts(new Date(2e3, 11, 25));
  return parts15.map(({ type, value }) => type === "literal" ? `${value}?` : `((?!=<${type}>)\\d+)?`).join("");
}
...
var getItemId5 = (ctx, id) => `${ctx.id}/${id}`;
...
var getTriggerEl6 = (ctx) => ctx.getById(getTriggerId7(ctx));
var getItemEl3 = (ctx, value) => value ? ctx.getById(getItemId5(ctx, value)) : null;
...
function connect14(service, normalize) {
  ...
  function getItemState(props22) {
    return {
      id: getItemId5(scope, props22.value),
      disabled: !!props22.disabled,
...
var { not: not8, and: and7, or: or2 } = createGuards();
  ...
  states: {
    ...
    open: {
      ...
      on: {
        ...
        TRIGGER_CLICK: [
          {
            guard: and7(not8("isTriggerItem"), "isOpenControlled"),
            actions: ["invokeOnClose"]
          },
          {
            guard: not8("isTriggerItem"),
            target: "closed",
            actions: ["invokeOnClose"]
          }
        ],
        ...
        ITEM_POINTERLEAVE: {
          guard: and7(not8("isPointerSuspended"), not8("isTriggerItem")),
          actions: ["clearHighlightedItem"]
        },
        ITEM_CLICK: [
          // == grouped ==
          {
            guard: and7(
              not8("isTriggerItemHighlighted"),
              not8("isHighlightedItemEditable"),
              "closeOnSelect",
              "isOpenControlled"
            ),
          ...
          {
            guard: and7(not8("isTriggerItemHighlighted"), not8("isHighlightedItemEditable"), "closeOnSelect"),
            target: "closed",
            actions: ["invokeOnSelect", "setOptionState", "closeRootMenu", "invokeOnClose"]
          },
          //
          {
            guard: and7(not8("isTriggerItemHighlighted"), not8("isHighlightedItemEditable")),
  ...
  implementations: {
    ...
    actions: {
      ...
      focusTrigger({ scope, context, event }) {
        ...
        queueMicrotask(() => getTriggerEl6(scope)?.focus({ preventScroll: true }));
      },
      ...
      closeSiblingMenus({ refs, event, scope }) {
        ...
        for (const id in children) {
          ...
          getContentEl7(scope)?.focus({ preventScroll: true });
...
var itemProps5 = createProps()(["closeOnSelect", "disabled", "value", "valueText"]);
...
var Menu = class extends Component {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  initMachine(props14) {
    return new VanillaMachine(machine14, props14);
  }
  initApi() {
...
var corex_eager_default = EagerHooks;
//# sourceMappingURL=corex-eager.cjs.js.map
