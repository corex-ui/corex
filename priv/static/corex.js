...
var Corex = (() => {
  ...
  function createScope(props7) {
    const getRootNode2 = () => {
      var _a, _b;
      return (_b = (_a = props7.getRootNode) == null ? void 0 : _a.call(props7)) != null ? _b : document;
    };
    ...
    return __spreadProps(__spreadValues({}, props7), {
  ...
  function bindable(props7) {
    var _a, _b;
    const initial = (_a = props7().value) != null ? _a : props7().defaultValue;
    if (props7().debug) {
      console.log(`[bindable > ${props7().debug}] initial`, initial);
    }
    const eq = (_b = props7().isEqual) != null ? _b : Object.is;
    ...
    return {
      ...
      set(nextValue) {
        ...
        if (!eq(next, prev)) {
          (_b2 = (_a2 = props7()).onChange) == null ? void 0 : _b2.call(_a2, next, prev);
        }
      },
      invoke(nextValue, prevValue) {
        var _a2, _b2;
        (_b2 = (_a2 = props7()).onChange) == null ? void 0 : _b2.call(_a2, nextValue, prevValue);
      },
      hash(value) {
        var _a2, _b2, _c;
        return (_c = (_b2 = (_a2 = props7()).hash) == null ? void 0 : _b2.call(_a2, value)) != null ? _c : String(value);
      }
    };
  }
  ...
  var VanillaMachine = class {
    constructor(machine8, userProps = {}) {
      ...
      const prop = (key) => {
        ...
        const props7 = (_b2 = (_a2 = machine8.props) == null ? void 0 : _a2.call(machine8, { props: compact(__props), scope: this.scope })) != null ? _b2 : __props;
        return props7[key];
      };
      this.prop = prop;
      const context = (_a = machine8.context) == null ? void 0 : _a.call(machine8, {
        prop,
        bindable,
        scope: this.scope,
        flush(fn) {
      ...
      const computed = (key) => {
        var _a2, _b2;
        return (_b2 = (_a2 = machine8.computed) == null ? void 0 : _a2[key]({
          context: ctx,
          event: this.getEvent(),
          prop,
          refs: this.refs,
      ...
      const refs = createRefs((_c = (_b = machine8.refs) == null ? void 0 : _b.call(machine8, { prop, context: ctx })) != null ? _c : {});
      this.refs = refs;
  ...
  var Component = class {
    constructor(el, props7) {
      ...
      __publicField(this, "spreadProps", (el, props7) => {
        spreadProps(el, props7);
      });
      __publicField(this, "updateProps", (props7) => {
  ...
  var ToggleGroupHook = {
    mounted() {
      const el = this.el;
      const pushEvent = this.pushEvent.bind(this);
      const props7 = __spreadProps(__spreadValues({
        id: el.id
      }, getBoolean(el, "controlled") ? { value: getStringList(el, "value") } : { defaultValue: getStringList(el, "defaultValue") }), {
  ...
  function connect4(service, normalize) {
    ...
    return {
      ...
      getValueTextProps() {
        return normalize.element(__spreadProps(__spreadValues({}, parts4.valueText.attrs), {
          dir: prop("dir"),
          "data-disabled": dataAttr2(disabled),
          "data-invalid": dataAttr2(invalid),
          "data-focus": dataAttr2(focused)
      ...
      getItemTextProps(props22) {
        const itemState = getItemState(props22);
        return normalize.element(__spreadProps(__spreadValues({}, parts4.itemText.attrs), {
          "data-state": itemState.selected ? "checked" : "unchecked",
          "data-disabled": dataAttr2(itemState.disabled),
          "data-highlighted": dataAttr2(itemState.highlighted)
        }));
      ...
      getItemGroupLabelProps(props22) {
        ...
        return normalize.element(__spreadProps(__spreadValues({}, parts4.itemGroupLabel.attrs), {
      ...
      getClearTriggerProps() {
        return normalize.button(__spreadProps(__spreadValues({}, parts4.clearTrigger.attrs), {
      ...
      getPositionerProps() {
        return normalize.element(__spreadProps(__spreadValues({}, parts4.positioner.attrs), {
          dir: prop("dir"),
            ...
            const keyMap3 = {
              ...
              Space(event2) {
                ...
                if (isTypingAhead) {
                  ...
                  (_a = keyMap3.Enter) == null ? void 0 : _a.call(keyMap3, event2);
                }
              }
            };
            const exec = keyMap3[getEventKey2(event)];
      ...
      getListProps() {
        return normalize.element(__spreadProps(__spreadValues({}, parts4.list.attrs), {
          tabIndex: 0,
  ...
  var machine4 = createMachine3({
    props({ props: props22 }) {
      ...
      return __spreadProps(__spreadValues({
        ...
        collection: (_a = props22.collection) != null ? _a : collection.empty(),
    ...
    implementations: {
      ...
      actions: {
        reposition({ context, prop, scope, event }) {
          const positionerEl = () => getPositionerEl(scope);
          getPlacement(getTriggerEl(scope), positionerEl, __spreadProps(__spreadValues(__spreadValues({}, prop("positioning")), event.options), {
            defer: true,
            listeners: false,
            onComplete(data) {
              context.set("currentPlacement", data.placement);
        ...
        scrollContentToTop({ prop, scope }) {
          ...
          if (prop("scrollToIndexFn")) {
            ...
            (_b = getContentEl(scope)) == null ? void 0 : _b.scrollTo(0, 0);
          }
        },
  ...
  var Select = class extends Component {
    ...
    initMachine(props7) {
      const self2 = this;
      return new VanillaMachine(machine4, __spreadProps(__spreadValues({}, props7), {
        get collection() {
  ...
  function connect5(service, normalize) {
    ...
    return {
      ...
      getThumbProps() {
        return normalize.element(__spreadProps(__spreadValues(__spreadValues({}, parts5.thumb.attrs), dataAttrs), {
          dir: prop("dir"),
          id: getThumbId(scope),
          "aria-hidden": true
        }));
  ...
  function connect6(service, normalize) {
    ...
    return {
      ...
      getPositionerProps() {
        return normalize.element(__spreadProps(__spreadValues({}, parts6.positioner.attrs), {
          dir: prop("dir"),
      ...
      getListProps() {
        return normalize.element(__spreadProps(__spreadValues({}, parts6.list.attrs), {
          role: !composite ? "listbox" : void 0,
          "data-empty": dataAttr2(collection22.size === 0),
          "aria-labelledby": getLabelId3(scope),
          "aria-multiselectable": prop("multiple") && !composite ? true : void 0
      ...
      getItemProps(props22) {
        ...
        return normalize.element(__spreadProps(__spreadValues({}, parts6.item.attrs), {
          dir: prop("dir"),
      ...
      getItemTextProps(props22) {
        const itemState = getItemState(props22);
        return normalize.element(__spreadProps(__spreadValues({}, parts6.itemText.attrs), {
          dir: prop("dir"),
          "data-state": itemState.selected ? "checked" : "unchecked",
          "data-disabled": dataAttr2(itemState.disabled),
          "data-highlighted": dataAttr2(itemState.highlighted)
      ...
      getItemGroupProps(props22) {
        const { id } = props22;
        return normalize.element(__spreadProps(__spreadValues({}, parts6.itemGroup.attrs), {
          dir: prop("dir"),
      ...
      getItemGroupLabelProps(props22) {
        const { htmlFor } = props22;
        return normalize.element(__spreadProps(__spreadValues({}, parts6.itemGroupLabel.attrs), {
          dir: prop("dir"),
  ...
  var Combobox = class extends Component {
    ...
    initMachine(props7) {
      const self2 = this;
      return new VanillaMachine(machine6, __spreadProps(__spreadValues({}, props7), {
        get collection() {
          return self2.getCollection();
        },
  ...
  function isKeyboardFocusEvent2(isTextInput, modality, e) {
    ...
    isTextInput = isTextInput || target instanceof win.HTMLInputElement && !nonTextInputTypes2.has(target == null ? void 0 : target.type) || target instanceof win.HTMLTextAreaElement || target instanceof win.HTMLElement && target.isContentEditable;
  ...
  function trackFocusVisible2(props7 = {}) {
    ...
    onChange == null ? void 0 : onChange({ isFocusVisible: autoFocus || isFocusVisible2(), modality: currentModality2 });
    const handler = (modality, e) => {
      if (!isKeyboardFocusEvent2(!!isTextInput, modality, e)) return;
      onChange == null ? void 0 : onChange({ isFocusVisible: isFocusVisible2(), modality });
    };
  ...
  function connect7(service, normalize) {
    ...
    return {
      ...
      getRootProps() {
        return normalize.label(__spreadProps(__spreadValues(__spreadValues({}, parts7.root.attrs), dataAttrs), {
          dir: prop("dir"),
          id: getRootId7(scope),
      ...
      getLabelProps() {
        return normalize.element(__spreadProps(__spreadValues(__spreadValues({}, parts7.label.attrs), dataAttrs), {
          dir: prop("dir"),
          id: getLabelId4(scope)
        }));
      },
      getControlProps() {
        return normalize.element(__spreadProps(__spreadValues(__spreadValues({}, parts7.control.attrs), dataAttrs), {
          dir: prop("dir"),
      ...
      getIndicatorProps() {
        return normalize.element(__spreadProps(__spreadValues(__spreadValues({}, parts7.indicator.attrs), dataAttrs), {
          dir: prop("dir"),
    ...
    implementations: {
      ...
      effects: {
        ...
        trackFocusVisible({ computed, scope }) {
          var _a;
          if (computed("disabled")) return;
          return trackFocusVisible2({ root: (_a = scope.getRootNode) == null ? void 0 : _a.call(scope) });
        },
        trackFormControlState({ context, scope }) {
