...
var Corex = (() => {
  ...
  function connect8(service, normalize) {
    ...
    return {
      ...
      focus() {
        ...
        const value = context.get("value");
        if (!value) return;
        (_a = getTriggerEl3(scope, value)) == null ? void 0 : _a.focus();
      },
      getRootProps() {
  ...
  var SignaturePadHook = {
    ...
    updated() {
      var _a;
      (_a = this.signaturePad) == null ? void 0 : _a.updateProps({
        id: this.el.id,
        drawing: {
