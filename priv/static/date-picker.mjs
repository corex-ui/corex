...
// ../node_modules/@zag-js/date-picker/dist/date-picker.anatomy.mjs
...
// ../node_modules/@zag-js/date-utils/dist/constrain.mjs
...
// ../node_modules/@zag-js/date-utils/dist/align.mjs
...
// ../node_modules/@zag-js/date-utils/dist/assertion.mjs
...
// ../node_modules/@zag-js/date-utils/dist/duration.mjs
...
// ../node_modules/@zag-js/date-utils/dist/get-era-format.mjs
...
// ../node_modules/@zag-js/date-utils/dist/formatter.mjs
...
// ../node_modules/@zag-js/date-utils/dist/format.mjs
...
// ../node_modules/@zag-js/date-utils/dist/date-month.mjs
...
// ../node_modules/@zag-js/date-utils/dist/date-year.mjs
...
// ../node_modules/@zag-js/date-utils/dist/mutation.mjs
...
// ../node_modules/@zag-js/date-utils/dist/pagination.mjs
...
// ../node_modules/@zag-js/date-utils/dist/locale.mjs
...
function getLocaleSeparator(locale) {
  ...
  const parts2 = new Intl.DateTimeFormat(locale).formatToParts(/* @__PURE__ */ new Date());
  const literal = parts2.find((part) => part.type === "literal");
  separator = literal ? literal.value : "/";
  separatorCache.set(locale, separator);
  return separator;
}

// ../node_modules/@zag-js/date-utils/dist/parse-date.mjs
...
// ../node_modules/@zag-js/date-utils/dist/preset.mjs
...
// ../node_modules/@zag-js/date-picker/dist/date-picker.dom.mjs
...
// ../node_modules/@zag-js/date-picker/dist/date-picker.utils.mjs
...
// ../node_modules/@zag-js/date-picker/dist/date-picker.connect.mjs
...
// ../node_modules/@zag-js/date-picker/dist/date-picker.machine.mjs
...
// ../node_modules/@zag-js/date-picker/dist/date-picker.parse.mjs
...
var DATE_PICKER_UPDATE_ATTR_KEYS = [
  "dir",
  "locale",
  "timeZone",
  "disabled",
...
function tryParseDate(raw, label = "date") {
  try {
    return parse(raw);
  } catch (error) {
...
function tryParseDateList(values) {
...
var DatePickerHook = createZagLiveHook({
  key: "datePicker",
  ...
  mount(hook, { dom, server }) {
    ...
    const parseList = (v) => tryParseDateList(v);
    const parseOne = (v) => v ? tryParseDate(v, "focusedValue") : void 0;
    ...
    const datePickerInstance = new DatePicker(el, {
      ...
      min: min ? tryParseDate(min, "min") : void 0,
      max: max ? tryParseDate(max, "max") : void 0,
      ...
      onValueChange: (details) => {
        const isoList2 = isoListFromValues(details.value);
        const isMountEcho = hook.fieldTouched !== true && sameStringList(isoList2, initialIsoList);
        if (!isMountEcho) {
          hook.fieldTouched = true;
        }
        const submitName2 = getString(el, "submitName");
        if (submitName2) {
          setArrayValues(el, isoList2, {
            scope: "date-picker",
            submitName: submitName2,
            notifyLiveView: !isMountEcho
          });
        } else {
          const isoStr = isoList2.length > 0 ? isoList2.join(",") : "";
        ...
        notifyChange({
          ...
          payload: {
            id: el.id,
            value: isoList2.length > 0 ? isoList2.join(",") : null
          },
    ...
    server.add("date_picker_set_value", (payload) => {
    ...
    dom.add("corex:date-picker:set-value", (event) => {
