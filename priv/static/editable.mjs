...
// ../node_modules/.pnpm/@zag-js+editable@1.33.1/node_modules/@zag-js/editable/dist/index.mjs
...
var EditableHook = {
  mounted() {
    ...
    const zag = new Editable(el, {
      id: el.id,
      ...controlled && value !== void 0 ? { value } : { defaultValue: defaultValue ?? "" },
