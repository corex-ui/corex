...
// ../node_modules/.pnpm/@zag-js+progress@1.43.3/node_modules/@zag-js/progress/dist/progress.anatomy.mjs
...
// ../node_modules/.pnpm/@zag-js+progress@1.43.3/node_modules/@zag-js/progress/dist/progress.dom.mjs
...
// ../node_modules/.pnpm/@zag-js+progress@1.43.3/node_modules/@zag-js/progress/dist/progress.connect.mjs
...
// ../node_modules/.pnpm/@zag-js+progress@1.43.3/node_modules/@zag-js/progress/dist/progress.machine.mjs
...
var Progress = class extends Component {
  initMachine(props) {
  ...
  render() {
    const root = this.el.querySelector('[data-scope="progress"][data-part="root"]') ?? this.el;
    this.spreadProps(root, this.api.getRootProps());
    const track = this.el.querySelector('[data-scope="progress"][data-part="track"]');
    if (track) this.spreadProps(track, this.api.getTrackProps());
    const range = this.el.querySelector('[data-scope="progress"][data-part="range"]');
    if (range) this.spreadProps(range, this.api.getRangeProps());
    const circle = this.el.querySelector('[data-scope="progress"][data-part="circle"]');
    if (circle) this.spreadProps(circle, this.api.getCircleProps());
    const circleTrack = this.el.querySelector(
      '[data-scope="progress"][data-part="circle-track"]'
    );
    if (circleTrack) this.spreadProps(circleTrack, this.api.getCircleTrackProps());
    const circleRange = this.el.querySelector(
...
// hooks/progress.ts
function progressProps(el, hook) {
