...
// ../node_modules/.pnpm/@zag-js+qr-code@1.43.3/node_modules/@zag-js/qr-code/dist/qr-code.anatomy.mjs
var anatomy = createAnatomy("qr-code").parts("root", "frame", "pattern", "overlay", "downloadTrigger");
var parts = anatomy.build();

// ../node_modules/.pnpm/@zag-js+qr-code@1.43.3/node_modules/@zag-js/qr-code/dist/qr-code.dom.mjs
...
async function getDataUrl2(scope, options) {
  ...
  return getDataUrl(clone, { ...options, size: { width: svgRect.width, height: svgRect.height } });
}
...
// ../node_modules/.pnpm/@zag-js+qr-code@1.43.3/node_modules/@zag-js/qr-code/dist/qr-code.connect.mjs
...
// ../node_modules/.pnpm/@zag-js+qr-code@1.43.3/node_modules/@zag-js/qr-code/dist/qr-code.machine.mjs
  ...
  implementations: {
    actions: {
      ...
      downloadQrCode({ event, scope }) {
        ...
        getDataUrl2(scope, { type: mimeType, quality }).then((dataUri) => {
...
var QrCode2 = class extends Component {
  initMachine(props) {
  ...
  render() {
    const root = this.el.querySelector('[data-scope="qr-code"][data-part="root"]') ?? this.el;
    this.spreadProps(root, this.api.getRootProps());
    const frame = this.el.querySelector('[data-part="frame"]');
...
var QrCodeHook = createZagLiveHook({
  key: "qr-code",
  mount(hook) {
    return new QrCode2(hook.el, qrCodeProps(hook.el, hook));
  },
  update(hook, inst) {
